      ...
      <div className="grid-2" style={{ marginBottom: '2rem' }}>
        <div className="card">
          ...
          {stats.bloodGroupDistribution.map(item => (
            <div key={item._id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem', background: 'var(--bg-main)', borderRadius: '8px', marginBottom: '0.5rem' }}>
      ...
      <div className="card">
        ...
        <div className="grid-3">
          {stats.topLocations.map((item, index) => (
            <div key={index} style={{ padding: '1rem', background: 'var(--bg-main)', borderRadius: '8px', textAlign: 'center' }}>
