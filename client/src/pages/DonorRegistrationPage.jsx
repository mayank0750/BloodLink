...
import { Heart, CheckCircle, AlertCircle, MapPin, Navigation } from 'lucide-react';
import { BLOOD_GROUPS, ORGANS, GENDERS, getCurrentLocation } from '../services/api';
...
const handleTalukaChange = (e) => {
  ...
  const handleCaptureLocation = async () => {
    ...
    try {
      ...
      setErrorMessage(`Unable to get location: ${error.message}. Please allow location access or enter manually.`);
  ...
  showConsentModal && (
    <div className="modal-overlay">
      ...
      >
        ...
        >
          <p>
            By registering as a donor, you agree that the
            information provided by you may be stored and
            processed by our platform for donor matching,
            emergency communication, and healthcare related
            services.
          </p>

          <p>
            We may use your contact information including
            mobile number and email address to:
          </p>

          <ul>
            <li>
              Contact you regarding blood or organ donation
              opportunities.
            </li>
            <li>
              Notify you about emergency donor requests.
            </li>
            <li>
              Send awareness campaigns, newsletters and
              health-related updates.
            </li>
            <li>
              Improve our donor network and services.
            </li>
          </ul>

          <p>
            Your information may be shared with verified
            hospitals, NGOs, healthcare organizations and
            authorized personnel strictly for donor
            identification and communication purposes.
          </p>

          <p>
            We do not sell your personal data to third
            parties. Reasonable security measures are used
            to protect your information.
          </p>

          <p>
            You may request removal of your donor profile at
            any time by contacting the platform
            administrator.
          </p>
        </div>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            {['blood', 'organ', 'both'].map(type => (
              <label key={type} style={{
                ...
                borderRadius: '8px',
                cursor: 'pointer',
                background: formData.donorType === type ? 'rgba(200, 30, 30, 0.05)' : 'transparent',
                transition: 'all 0.2s',
                textAlign: 'center',
                fontWeight: 600
              }}>
                <input
                  ...
                  style={{ display: 'none' }}
                />
                {type === 'blood' ? 'Blood' : type === 'organ' ? 'Organ' : 'Both'}
              </label>
            ))}
          </div>
        </div>
      ...
      {taluka}
        ...
        <div className="form-group" style={{ 
          ...
          <label className="form-label" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <MapPin size={20} />
            Capture Your Location (Optional but Recommended)
          </label>
          <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', marginBottom: '1rem' }}>
            This helps users find donors near them more easily
          </p>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            ...
            >
              <Navigation size={18} />
              {locationLoading ? 'Getting Location...' : locationCaptured ? 'Location Captured ✓' : 'Use My Current Location'}
            </button>
          ...
          <div style={{ marginTop: '1rem' }}>
            ...
            <div className="grid-2">
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label" style={{ fontSize: '0.85rem' }}>Latitude</label>
                <input
                  type="number"
                  step="any"
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label" style={{ fontSize: '0.85rem' }}>Longitude</label>
                <input
                  type="number"
                  step="any"
